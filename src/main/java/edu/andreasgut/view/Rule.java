...
public class Rule {
    ...
    static public LinkedList<Rule> getRules(){
        ...
        rules.add(new Rule("Ziel des Spiels", "Ziel des Spiels ist es, durch das Bilden von Mühlen (3 eigene Steine in einer Reihe), dem Gegenspieler Steine wegzunehmen, bis er weniger als 3 Steine hat und somit keine Mühlen mehr bauen kann.", "Ziel, Mühle, Steine"));
        ...
        rules.add(new Rule("Geschlossene Mühle", "Als geschlossene werden 3 Steine derselben Farbe in einer horizontalen oder vertikalen Linie bezeichnet. Wird eine Mühle gebildet, so darf ein gegnerischer Stein entfernt werden. Gegnerische Steine, die ebenfalls in einer geschlossenen Mühle liegen, dürfen nicht entfernt werden, ausser es sind nur noch 3 Steine übrig.", "verboten, Ausnahme, Mühle"));
        ...
        rules.add(new Rule("Verbotene Steine", "Steine, die in einer Mühle liegen, dürfen nicht entfernt werden. Hat ein(e) Spieler(in) die eigenen Steine alle in geschlossenen Mühlen, so darf kein Stein entfernt werden, es sei denn, der/die Spieler(in) besitzt nur noch 3 Steine.", "Sonderfall, verboten"));
        rules.add(new Rule("Unentschieden", "In einigen Regelwerken endet das Spiel unentschieden, wenn nach einer bestimmten Anzahl Zügen, kein Sieg erreicht werden konnte. Diese Spielversion enthält keine Zugobergrenze, die zu einem Unentschieden führt", "unentschieden"));
