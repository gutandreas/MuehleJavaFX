...
public class Rule {
    ...
    private final static LinkedList<Rule> rules = new LinkedList<>();
    ...
    static {
        ...
        rules.add(new Rule("Offene Mühle", "Als offene Mühle werden 3 Steine derselben Farbe bezeichnet, die im folgenden Zug zu einer geschlossenen Mühle verschoben werden können", "offen"));
        rules.add(new Rule("Zwickmühle", "Eine Zwickmühle entsteht, wenn beim Öffnen einer Mühle, eine andere Mühle geschlossen werden kann. Eigene Zwickmühlen sind sehr wertvoll, gegnerische Zwickmühlen gilt es möglichst zu verhindern.", "Doppelmühle, öffnen, schliesssen"));
        ...
        rules.add(new Rule("Unentschieden", "In einigen Regelwerken endet das Spiel unentschieden, wenn nach 20 bzw. 50 Zügen keine Mühle gebildet werden konnte. Diese Spielversion enthält keine Zugobergrenze, die zu einem Unentschieden führt.", "unentschieden"));
    }
